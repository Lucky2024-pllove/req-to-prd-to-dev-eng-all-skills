<div align="center">
  ...
  <p>
    ...
    一套面向 Agent 的开放 <strong>SKILL.md</strong> <strong>monorepo</strong>：从用户需求到整理成<strong>需求分析 + PRD</strong>，再落地为<strong>开发说明、测试用例、开发任务确认单</strong>，最后产出<strong>分工计划、todolist、工程交付检查清单</strong>（及按需的数据库脚本草案、AI 任务卡）。<br>
    适用于 Cursor、Claude Code、Codex 等环境。
  </p>
</div>
