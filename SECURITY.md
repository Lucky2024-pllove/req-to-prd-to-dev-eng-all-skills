...
本 monorepo 为 **文档型 Agent Skill 集合**，不含服务端运行时。主要风险是 **误提交机密** 或在 Issue/PR 中粘贴真实令牌与未脱敏业务数据。
...
| 业务与客户机密 | 见 [requirements-to-prd/SECURITY.md](requirements-to-prd/SECURITY.md) |
| 本地覆盖 | `*.local.md`、`.env*` — 已在 [.gitignore](.gitignore) 忽略 |

## 各技能细则

- [requirements-to-prd/SECURITY.md](requirements-to-prd/SECURITY.md) — 需求/PRD 阶段
